...
const ProductsServicesPage: React.FC<ProductsServicesPageProps> = ({ userRole, userBranchId, currentClientId }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-indigo-800 to-purple-800 rounded-2xl p-6 shadow-xl">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-indigo-200">Kelola produk dan layanan barbershop</p>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full bg-gray-50 border border-gray-300 rounded-lg pl-10 pr-4 py-3 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
            />
          </div>
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="bg-gray-50 border border-gray-300 rounded-lg px-4 py-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {filteredItems.map((item) => (
          <div key={item.id} className="bg-white rounded-xl shadow-lg border border-gray-200 hover:border-indigo-300 transition-all duration-300 overflow-hidden">
            <div className={`p-4 ${item.type === 'product' ? 'bg-gradient-to-r from-violet-600 to-purple-600' : 'bg-gradient-to-r from-blue-600 to-indigo-600'}`}>
            ...
            <div className="p-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {item.type === 'product' && item.stock !== null && (
                    <div className="text-right">
                      ...
                      <p className={`font-bold ${item.stock > 10 ? 'text-green-600' : item.stock > 5 ? 'text-yellow-600' : 'text-red-600'}`}>
                        {item.stock}
                      </p>
                    </div>
                  )}
                ...
                <div className="flex gap-2 mt-6">
                  <button className="flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium py-2 px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-2">
                    <Edit3 size={16} />
                    Edit
                  </button>
      ...
      {filteredItems.length === 0 && (
        <div className="bg-white rounded-xl p-12 text-center shadow-lg border border-gray-200">
          ...
          <h3 className="text-xl font-bold text-gray-600 mb-2">Tidak ada item ditemukan</h3>
